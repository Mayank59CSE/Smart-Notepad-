...
# class Notepad:
#     def __init__(self):
#         self.text_widget = None  # Initialize text_widget attribute
...
#         self.set_status_bar()
#         self.set_file_Amenu_event_bindings()
#
...
#         result = self.translator.translate(text, target_language=self.target_language)
...
#
#         self.elapsed_time_label = ttk.Label(self.status_bar, text='00:00:00')
#         self.elapsed_time_label.pack(side=tk.RIGHT, padx=10)
#
#         # Start the timer when the application is launched
#         self.start_time = time.time()
#         self.update_elapsed_time()
#
#     def update_elapsed_time(self):
#         """Update the elapsed time on the status bar."""
...
#
#         # Retrieve total elapsed time in seconds
#         total_elapsed_seconds = elapsed_seconds
#         print(f"Total elapsed time in seconds: {total_elapsed_seconds}")
#
...
#                 self.hide_toolbar()
#             else:
#                 translated_text = self.translate_text(self.takeAudio)
